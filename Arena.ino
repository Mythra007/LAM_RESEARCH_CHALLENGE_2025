...
#include <SPI.h>
#include "HX711.h"
#include "team_photo.h" // contains lcd_test_pic_1

// ==========================================
// --- LCD PINS (Your Config) ---
#define TFT_CS   26
#define TFT_RST  33
#define TFT_DC   32
#define TFT_MOSI 23
...
// --- SENSOR PINS (IR GATES) ---
#define PIN_IR_GATE_1  16 // Detects car at Pump Station (active-LOW => 0 when detected)
#define PIN_IR_GATE_2  14 // Detects car at LAM LED Station
#define PIN_IR_GATE_3  17 // Detects car at Load Cell Station

// --- ACTUATOR PINS ---
// NOTE: Pump and LAM are active-LOW in this version. Drive LOW to turn ON.
#define PIN_PUMP       13 // Controls the DC Pump (use MOSFET/driver!)
#define PIN_LAM_LED    4  // Controls the LAM LED
...
//              SETTINGS
// ==========================================
const unsigned long DEFAULT_PUMP_RUN_TIME_MS = 3000UL; // default pump runtime
unsigned long pumpRunTimeMs = DEFAULT_PUMP_RUN_TIME_MS; // can be changed via serial

const float LOADCELL_CALIBRATION_FACTOR = 2280.0; // calibrate this
const float TARGET_WEIGHT_MIN = 120.0; // grams
const float TARGET_WEIGHT_MAX = 130.0; // grams

// Debounce settings for IR gates
const unsigned long DEBOUNCE_MS = 50;

// HX711 reading settings
...
// Sensor state tracking for edge detection + debounce
